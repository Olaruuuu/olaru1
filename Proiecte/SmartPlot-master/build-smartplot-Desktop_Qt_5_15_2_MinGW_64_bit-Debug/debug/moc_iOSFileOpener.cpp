/****************************************************************************
** Meta object code from reading C++ file 'iOSFileOpener.h'
**
...
#include <memory>
#include "../../src/ios/iOSFileOpener.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'iOSFileOpener.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 29, 3) // "url"
    ...
    "myUrlHandler\0openFile\0\0files\0url"
};
...
void myUrlHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<myUrlHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->files((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (myUrlHandler::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myUrlHandler::openFile)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myUrlHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_myUrlHandler.data,
    qt_meta_data_myUrlHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void myUrlHandler::openFile(const QString & _t1)
{
